...
int main()
{
	...
	//Girilen iki sayýdan büyük olanýnýn karesini ekrana yazdýralým.
	//Eðer sayýlar birbirine eþitse sayýlardan herhangi birini alýp, karesini yazdýrabiliriz.
	...
	{
		if (i % 3 == 0)
			toplam3 += i; //toplam3=toplam3+i;
		if (i % 5 == 0)
			toplam5 += i; //toplam5=toplam5+i;
	}
	cout << "3'e tam bölünenlerin toplamý:" << toplam3 << endl;
	cout << "5'e tam bölünenlerin toplamý:" << toplam5 << endl;
