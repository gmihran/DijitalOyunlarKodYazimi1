...
int main()
{
	...
	//Ýki matrisin toplamýný hesaplayan programý yazýnýz.
	//Matrisler 5*2 boyutunda ve içerisinde 1 ile 100 arasýnda rastgele sayý tutmalarýný saðlayalým.
	srand(time(NULL));
	int matris1[5][2], matris2[5][2], i, j;
	cout << "1. matris:\n";
	for (i = 0; i <= 4; i++) //satýrlar
	{
	...
	//matris1 ve matris2 Toplamlarý
	cout << "Ýki matrisin toplamý\n";
	for (i = 0; i <= 4; i++) //satýrlar
	{
		for (j = 0; j <= 1; j++) //sütunlar
		{
